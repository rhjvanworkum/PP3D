...
Sidebar.Object = function ( editor ) {
	...
	// Actions
	var objectActionsRow = new UI.Row();
	objectActionsRow.add( new UI.Text('Snap object to surface').setWidth( '180px' ) );
	var objectActions = new UI.Select().setPosition( 'absolute' ).setRight( '8px' ).setFontSize( '16px' );
	objectActions.setOptions( {

		'Snap to surface': 'Snap to surface',
	...
	objectActions.onChange( function ( event ) {
		...
		switch ( this.getValue() ) {
			...
			case 'Snap to surface':
				var bbox = new THREE.Box3().setFromObject(object);
				var align = bbox.getSize().z;
				editor.execute( new SetPositionCommand( editor, object, new THREE.Vector3( 0, align, 0 ) ) );
				break;
